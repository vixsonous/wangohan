...
export default function User() {
    ...
    return (
        <div className="w-[40px] h-[40px] relative">
            <img onClick={() => setDisplay(!display)} ref={userIcn} src={'/icons/user.webp'} className="self-center bg-white border-[2px] border-[#6b4528] rounded-[50%] relative" width={10000} height={10000}  alt="website banner" />
