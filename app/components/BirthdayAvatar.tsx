    ...
    return (
      <div key={key} className="flex flex-[0_0_100%] text-white flex flex-col items-center justify-center gap-[10px]">
        <div className="w-full flex justify-center">
            <img src={src.toString()} loading="lazy" className="w-[50px] rounded-full object-cover overflow-hidden h-[50px] max-w-none" width={100} height={100} alt="website banner" />
        </div>
