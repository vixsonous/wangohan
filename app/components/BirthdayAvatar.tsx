  ...
  return (
    <div className="relative flex flex-[0_0_100%] text-white flex flex-col items-center justify-center">
      <div className="w-full flex justify-center">
          <img src={src.toString()} loading="lazy" style={{scale: active ? 4 : 3}} className="w-12 h-12 transition-all duration-1000 rounded-full object-cover overflow-hidden max-w-none" width={100} height={100} alt="website banner" />
      </div>
