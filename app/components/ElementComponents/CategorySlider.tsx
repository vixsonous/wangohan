...
const DogCategoryLg = memo(() => {
  return (
    <div
      id="category"
      className={`flex-col mt-4 justify-center w-[100%] items-start relative`}
    >
      <DogCategoryLgCore />
    </div>
  );
...
const events2 = [
  ...
  {
    text: "ダイエット",
    img: "/LP/event/diet.webp",
    url: "/recipe/search/ダイエット",
  },
];
  ...
  return (
    <>
      <div className="first-row w-full flex gap-4 justify-center flex-col items-center">
        ...
        <div className="grid grid-cols-3 gap-y-12 w-[100%]">{children}</div>
      </div>
    </>
  );
};
