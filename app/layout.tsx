            ...
            <div className="footer mt-[100px]">
              ...
              <div className="relative bg-[url('/LP/last.webp')]  bg-contain bg-no-repeat bg-bottom pb-[20vw]">
                <div className="grid grid-cols-12 p-4">
                  ...
                  <div className="col-span-4 grid grid-cols-3 justify-between items-center self-center w-[100%]">
                    <Link href="/inquiry/terms-of-service" className="text-xs self-center flex">利用規約</Link>
                    <Link href="/inquiry/disclaimer" className="text-xs self-center flex">免責事項</Link>
                    <Link href="/inquiry/privacy-policy" className="text-xs self-center flex">プライバシーポリシー</Link>
                    <Link href="/user" className="text-xs self-center flex">Myページ</Link>
                    <Link href="/" className="text-xs self-center flex">HOME</Link>
                    <Link href="/inquiry/send-inquiry" className="text-xs self-center flex">ご意見・お問い合わせ</Link>
                  </div>
                </div>
