...
export default function FinishSignup() {
    return (
        <div className={`flex flex-col px-[45px] py-[30px] gap-[10px] justify-center items-center ${inter.className}`}>
            <div className="flex flex-col justify-center items-start gap-[10px]">
                <h1 className="flex justify-center items-center font-bold text-[15px]">新規登録が完了しました！
                <img src={'/icons/logo-new.png'} className="rounded-md h-[auto] left-[15px] w-[50px] relative" width={100} height={100} alt="website banner" />
                </h1>
