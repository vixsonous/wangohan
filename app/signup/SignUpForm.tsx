...
export default function SignUpForm() {
  ...
  return (
    <>
      <form
        action=""
        className="w-[100%] max-w-[100%] sm:max-w-[460px] flex flex-col gap-[10px] items-center"
      >
        <input
          value={signup.email}
          onChange={(e) =>
            setSignup((prevState) => ({ ...prevState, email: e.target.value }))
          }
        ...
        <div className="relative w-full">
          ...
          <FontAwesomeIcon
            ...
            className="absolute cursor-pointer right-[12px] top-[12px]"
            icon={showPass ? faEye : faEyeSlash}
            size="lg"
          />
        </div>
        <button
          disabled={openGoogleSignup || signupState}
          onClick={(e: SyntheticEvent) => signUpFunc(e)}
          className={`w-[100%] bg-[#ffb762] h-12 transition-all duration-500 text-white py-[10px] rounded-md text-[12px] sm:text-[16px]`}
          type="submit"
        >
          {!signupState ? (
            "新規登録"
          ) : signupSuccess.regular ? (
            <>
              <span style={{ color: textColor.success }}>
                {SUCC_MSG.SUCCESS1}{" "}
              </span>
              <FontAwesomeIcon
                icon={faCheck}
                style={{ color: textColor.success }}
                size="lg"
              />
            </>
          ) : (
        ...
        <span className="text-[.5em] sm:text-[.75em] font-semibold text-[#E53935]">
          {error}
        </span>
      </form>
      <div className="w-[100%] max-w-[100%] sm:max-w-[460px] mt-[30px] gap-[10px] flex flex-col justify-center">
        ...
        >
          ...
          >
            <g clipPath="url(#clip0_50_449)">
              <path
                d="M66.9643 32.2042C66.9643 29.6139 66.7364 27.7237 66.2431 25.7634H34.167V37.4548H52.9949C52.6155 40.3603 50.5656 44.7359 46.0104 47.6761L45.9465 48.0675L56.0884 55.3126L56.791 55.3773C63.2441 49.8815 66.9643 41.7954 66.9643 32.2042Z"
                fill="#4285F4"
              />
              <path
                d="M34.1673 63.0084C43.3914 63.0084 51.1351 60.2079 56.7913 55.3774L46.0106 47.6762C43.1258 49.5315 39.2538 50.8266 34.1673 50.8266C25.1329 50.8266 17.465 45.3311 14.7317 37.7351L14.331 37.7665L3.78537 45.2925L3.64746 45.646C9.26546 55.9373 20.8053 63.0084 34.1673 63.0084Z"
                fill="#34A853"
              />
              <path
                d="M14.7322 37.7353C14.011 35.775 13.5936 33.6746 13.5936 31.5044C13.5936 29.334 14.011 27.2338 14.6942 25.2736L14.6751 24.8561L3.99732 17.2092L3.64796 17.3625C1.33252 21.6331 0.00390625 26.4288 0.00390625 31.5044C0.00390625 36.5801 1.33252 41.3755 3.64796 45.6462L14.7322 37.7353Z"
                fill="#FBBC05"
              />
              <path
                d="M34.1673 12.1815C40.5824 12.1815 44.9097 14.7368 47.3772 16.8722L57.019 8.19106C51.0974 3.11542 43.3914 0 34.1673 0C20.8053 0 9.26546 7.07086 3.64746 17.3621L14.6937 25.2733C17.465 17.6773 25.1329 12.1815 34.1673 12.1815Z"
                fill="#EB4335"
              />
            </g>
            <defs>
        ...
        <div className="flex justify-center gap-[2rem]">
          <span className="text-[8px] sm:text-[12px] font-semibold text-[#828282]">
            利用規約
          </span>
          <span className="text-[8px] sm:text-[12px] font-semibold text-[#828282]">
            プライバシーポリシー
