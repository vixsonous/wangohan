...
import { faArrowLeft, faBars, faBook, faChevronLeft, faChevronRight, faDashboard, faEdit, faHamburger, faMessage, faTrash, faUsers } from "@fortawesome/free-solid-svg-icons";
...
export default function Admin() {
    ...
    const recipes = [
        {id: 1, recipe_title: 'This is a recipe', user_first_name: 'Victor', user_last_name: 'Chiong', role: 1},
        {id: 2, recipe_title: 'This is another Recipe', user_first_name: 'Minami', user_last_name: 'Sakai', role: 2},
        {id: 3, recipe_title: 'WanWan Recipe', user_first_name: 'Kurmu', user_last_name: 'Sakai', role: 2},
    ]
        ...
        <div className="w-full p-4 flex flex-col gap-4">
            <section className="md:hidden">
                <div className="bg-secondary-bg p-2 rounded-full flex justify-between items-center">
                    ...
                    <Dropdown>
                      <ul className="block flex flex-col gap-2 bg-secondary-bg items-center p-2 rounded-md border border-primary-text">
                                        ...
                                        <div className="flex flex-col gap-1 py-1">
                                            <div className="flex justify-between items-center">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    <span className="text-xs">{recipe.user_first_name} {recipe.user_last_name}</span>
                                                </div>
                                                <div className="flex gap-1">
                                                    <FontAwesomeIcon size="xs" icon={faEdit} />
                                                    <FontAwesomeIcon size="xs" icon={faTrash}/>
