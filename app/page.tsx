...
const DogCategorySmCore = () => {
  return (
    ...
    <div className="first-row w-full flex gap-4 justify-center flex-col items-center  ">
      <h1 className="text-[20px] text-[#523636] font-semibold">年齢別で探す</h1>
      <div className="flex justify-between sm:justify-center w-[100%]">
        <Link href="/recipe/search/子犬" className="flex flex-[1_33%] gap-2 text-[#523636] font-bold flex-col justify-between items-center">
          <img src={'/LP/puppy.webp'} loading="lazy" className="relative rounded-md w-[50%]"  alt="website banner" />
          <span className="relative text-xs">子犬用レシピ</span>
        </Link>
        <Link href="/recipe/search/成犬" className="flex flex-[1_33%] gap-2 relative text-[#523636] font-bold flex-col justify-between items-center">
          <img src={'/LP/adult.webp'} loading="lazy" className="relative rounded-md w-[30%]" alt="website banner" />
          <span className="relative text-xs">成犬用レシピ</span>
        </Link>
        <Link href="/recipe/search/シニア犬" className="flex flex-[1_33%] gap-2 relative text-[#523636] font-bold flex-col justify-between items-center">
          <img src={'/LP/senior.webp'} loading="lazy" className="relative rounded-md w-[40%] bottom-[0px]"  alt="website banner" />
