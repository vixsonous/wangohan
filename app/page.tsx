...
const DogCategoryMedCore = () => {
  return (
    <>
      <div className="title">
        <h1 className="text-[26px] tracking-tighter font-bold text-[#523636] relative after:content-[''] z-[1] after:left-[-10px] after:w-[110%] after:h-[40px] after:top-[10px] after:z-[-1] after:flex after:absolute after:bg-[#FFE9C9]">
          レシピを探す
        </h1>
      ...
      <div className="first-row w-full flex gap-4 justify-center flex-col items-center  ">
        ...
        <div className="grid grid-cols-3 w-[100%]">
          ...
          <Link
            href="/recipe/search/成犬"
            className="flex gap-2 relative text-primary-text font-bold flex-col justify-center items-center"
          >
            <OptImage
              src={"/LP/adult-thumbnail.png"}
              height={70}
              loading="lazy"
              className="relative rounded-md"
              alt="website banner"
          ...
          <Link
            href="/recipe/search/シニア犬"
            className="flex gap-2 relative text-primary-text font-bold flex-col justify-center items-center"
          >
            <OptImage
              src={"/LP/senior-thumbnail.png"}
              height={70}
              loading="lazy"
              className="relative rounded-md bottom-[0px]"
              alt="website banner"
            />
      ...
      <div className="first-row mt-4 gap-4 w-full flex justify-center flex-col items-center  ">
        <h1 className="text-[20px] text-[#523636] font-semibold">
          サイズ別で探す
        </h1>
        <div className="grid grid-cols-3 w-[100%]">
          <Link
            href="/recipe/search/小型犬"
            className="flex gap-2 flex-col text-xs text-[#523636] font-bold justify-between items-center"
          >
            <OptImage
              src={"/LP/smalldog-thumbnail.png"}
              loading="lazy"
              className="relative rounded-md"
              height={70}
              alt="website banner"
          ...
          <Link
            href="/recipe/search/中型犬"
            className="flex gap-2 flex-col text-xs text-[#523636] font-bold justify-between items-center"
          >
            <OptImage
              src={"/LP/middledog-thumbnail.png"}
              loading="lazy"
              className="relative rounded-md"
              height={70}
              alt="website banner"
          ...
          <Link
            href="/recipe/search/大型犬"
            className="flex gap-2 flex-col relative text-xs text-[#523636] font-bold justify-between items-center"
          >
            <OptImage
              src={"/LP/bigdog-thumbnail.png"}
              loading="lazy"
              className="relative rounded-md"
              height={70}
              alt="website banner"
...
const DogCategoryMed = memo(() => {
  return (
    <div
      id="category-sm"
      className={`flex flex-col gap-[40px] justify-center items-center mt-[30px] lg:hidden relative`}
    >
      <DogCategoryMedCore />
    </div>
  );
      ...
      <MotionDiv>
        <div className="flex flex-col relative mt-16">
          ...
          <div className="absolute flex justify-center w-[100%] top-14 lg:top-24">
            <button className=" bg-primary-text rounded-md text-xs text-white py-2 px-4">
              Column
            </button>
          </div>
          <img
